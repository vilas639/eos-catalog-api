...
public class CatalogController {
    ...
    @PostMapping("/getallcatlogs")
    public ResponseEntity<Object> getAllcatlogitem()
    {
    	List<CatalogItem> catloglist=service.getItemAll();
    	
    	 return ResponseEntity.status(HttpStatus.SC_OK).body(catloglist);
    }
